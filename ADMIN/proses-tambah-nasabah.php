...
if($users) {
	...
	$nasabah = "INSERT INTO tb_nasabah (kode_nasabah, users_id, pekerjaan, tgl_daftar, nomor_rekening, saldo, pinjaman) VALUES ('$encrypted_kode', '$users_id','$pekerjaan', '$tgldaftar', '$encrypted_norek', '$saldo', '$pinjam')";
